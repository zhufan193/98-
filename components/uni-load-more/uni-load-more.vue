<template>
	<view class="uni-load-more" @click="onClick">
		...
		<view v-if="!webviewHide && (iconType==='circle' || iconType==='auto' && platform === 'android') && status === 'loading' && showIcon" :style="{width:iconSize+'px',height:iconSize+'px'}" class="uni-load-more__img uni-load-more__img--android-MP">
			<view class="uni-load-more__view" :style="{borderTopColor:color,borderTopWidth:iconSize/12}"></view>
			<view class="uni-load-more__view" :style="{borderTopColor:color,borderTopWidth:iconSize/12}"></view>
			<view class="uni-load-more__view" :style="{borderTopColor:color,borderTopWidth:iconSize/12}"></view>
		</view>
		<!-- #endif -->
...
<style scoped>
	...
	.uni-load-more__img--ios-H5>.uni-load-more__image {
		position: absolute;
		width: 100%;
		height: 100%;
		left: 0;
	...
	.uni-load-more__img--android-MP>.uni-load-more__view {
		position: absolute;
	...
	.uni-load-more__img--android-MP>.uni-load-more__view:nth-child(1) {
		animation: loading-android-MP-1 1s 0s linear infinite;
	}

	.uni-load-more__img--android-MP>.uni-load-more__view:nth-child(2) {
		animation: loading-android-MP-2 1s 0s linear infinite;
	}

	.uni-load-more__img--android-MP>.uni-load-more__view:nth-child(3) {
