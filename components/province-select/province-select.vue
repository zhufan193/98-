		...
		<view class="font-color">
			<scroll-view :scroll-top="scrollTop" scroll-y="true" style="" class="scroll-Y scroll-cla" @scrolltoupper="upper" @scrolltolower="lower"
				...
				<view v-for="(provin,index) in province" v-if="isProvin" >
					 <view :index="index" @click="turnCity" v-bind:id="index" class="pro-name">{{provin.name}}</view>
				</view>
			</scroll-view>
			<scroll-view :scroll-top="scrollTop" scroll-y="true" class="scroll-Y scroll-cla" @scrolltoupper="upper" @scrolltolower="lower"
				...
				<view v-for="(citym,index) in city" v-if="isCity" >
					<view :index="index" @click="submitCity" v-bind:id="index" class="pro-name">{{citym.name}}</view>
				</view>
			</scroll-view>
		</view>
	</view>
...
<script>
	import { province } from '@/config/cityJson.js';
	export default{
		data() {
			return {
				province:'',
		...
		methods:{
			turnCity:function(e){
				...
				this.city=province[e.target.id].city;
				this.prov=province[e.target.id].name;
			},
			submitCity:function(e){
				...
				this.prov=this.prov+"-"+this.city[e.target.id].name;
