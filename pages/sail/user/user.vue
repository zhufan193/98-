<template>
    <view class="page">
        ...
        <view v-else class="empty">
            ...
            <text class="empty__text">暂无我的船期发布信息</text>
        </view>
    </view>
</template>
	...
	export default {
        ...
        methods: {
            ...
            _goDetail(param) {
                ...
                router.navigateTo('/pages/sail/detail/detail', {id: this.data[param.index].id, router: 'user'});
            },
            getData(type = 'DownRefresh') {
                ...
                getSailList({filter: 'owner', page: this.page}).then(res => {
