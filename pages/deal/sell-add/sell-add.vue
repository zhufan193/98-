        ...
        <template v-if="userInfo.is_realname">
            <view class="card card--full form__list">
                <view class="form__cell">
                    ...
                    <radio-group class="form__radio" @change="_radioChange">
                        <label>
                            <radio color="#0091E6" style="transform:scale(0.7)" value="1" :checked="true" />个人出售
                        </label>
                        <label>
                            <radio color="#0091E6" style="transform:scale(0.7)" value="2" />企业出售
                        </label>
                    </radio-group>
                </view>
            ...
            <view class="card card--full form__list">
                ...
                <view class="form__cell">
                    ...
                    <input class="formInput__field formInput__field--right" v-model="data.name" placeholder="请输入船中文名" placeholder-style="color: #999;"/>
                </view>
                <view class="form__cell">
                ...
                <view class="form__cell">
                    <view class="form__label">出售价格（万元）</view>
                    <input class="formInput__field formInput__field--right" type="digit" v-model="data.price" placeholder="请输入出售价格" placeholder-style="color: #999;"/>
                </view>
            </view>
...
<script>
    ...
    import { uploadPic, postShipSell } from '@/service/getData.js';
	...
	export default {
        ...
        methods:{
            ...mapActions(['getReleaseCompany', 'getMyShipInfo', 'getShipType', 'getPosition']),
            _goPage(url) {
